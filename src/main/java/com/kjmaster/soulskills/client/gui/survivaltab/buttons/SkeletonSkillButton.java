 ...
 */
public class SkeletonSkillButton extends GuiButton {
    private ResourceLocation texture;

    public SkeletonSkillButton(int id, int x, int y, String text, ResourceLocation texture) {
    ...
    public void drawButton(Minecraft mc, int par2, int par3, float partialTicks) {
        if(enabled) {
            ...
            drawTexturedModalRect(x, y, 80, k == 2 ? 60 : 40, 20, 20);
        }
    }
}
