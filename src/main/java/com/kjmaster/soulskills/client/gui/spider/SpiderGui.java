package com.kjmaster.soulskills.client.gui.spider;
 ...
 */
public class SpiderGui extends MobGui {

    public SpiderGui(Container inventorySlotsIn) {
    ...
    public void updateScreen() {
        super.updateScreen();
        SoulSkillsPacketInstance.INSTANCE.sendToServer(new GetSoulsPacket("Spider"));
        ...
        String s = "Spider Souls: " + soulsSpider;
