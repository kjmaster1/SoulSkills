package com.kjmaster.soulskills.client.gui.magmacube;
 ...
 */
public class MagmaCubeGui extends MobGui {

    public MagmaCubeGui(Container inventorySlotsIn) {
    ...
    public void updateScreen() {
        super.updateScreen();
        SoulSkillsPacketInstance.INSTANCE.sendToServer(new GetSoulsPacket("MagmaCube"));
        EntityPlayer player = Minecraft.getMinecraft().player;
        ISouls soulsCap = player.getCapability(SoulsProvider.SOULS_CAPABILITY, null);
        int soulsMagmaCube = soulsCap.getSouls("MagmaCube");
        String s = "Magma Cube Souls: " + soulsMagmaCube;
