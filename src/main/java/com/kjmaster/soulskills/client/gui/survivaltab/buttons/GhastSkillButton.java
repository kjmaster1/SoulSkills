 ...
 */
public class GhastSkillButton extends GuiButton {
    private ResourceLocation texture;

    public GhastSkillButton(int id, int x, int y, String text, ResourceLocation texture) {
    ...
    public void drawButton(Minecraft mc, int par2, int par3, float partialTicks) {
        if(enabled) {
            ...
            drawTexturedModalRect(x, y, 20, k == 2 ? 20 : 0, 20, 20);
        }
    }
}
