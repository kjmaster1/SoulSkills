package com.kjmaster.soulskills.client.gui.witherskele;
 ...
 */
public class WitherSkeleGui extends MobGui {

    public WitherSkeleGui(Container inventorySlotsIn) {
    ...
    public void updateScreen() {
        super.updateScreen();
        SoulSkillsPacketInstance.INSTANCE.sendToServer(new GetSoulsPacket("WitherSkele"));
        EntityPlayer player = Minecraft.getMinecraft().player;
        ISouls soulsCap = player.getCapability(SoulsProvider.SOULS_CAPABILITY, null);
        int soulsWitherSkele = soulsCap.getSouls("WitherSkele");
        String s = "Wither Skeleton Souls: " + soulsWitherSkele;
