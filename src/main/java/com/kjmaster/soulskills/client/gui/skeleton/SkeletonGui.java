package com.kjmaster.soulskills.client.gui.skeleton;
 ...
 */
public class SkeletonGui extends MobGui {

    public SkeletonGui(Container inventorySlotsIn) {
    ...
    public void updateScreen() {
        super.updateScreen();
        SoulSkillsPacketInstance.INSTANCE.sendToServer(new GetSoulsPacket("Skeleton"));
        EntityPlayer player = Minecraft.getMinecraft().player;
        ISouls soulsCap = player.getCapability(SoulsProvider.SOULS_CAPABILITY, null);
        int soulsSkeleton = soulsCap.getSouls("Skeleton");
        String s = "Skeleton Souls: " + soulsSkeleton;
