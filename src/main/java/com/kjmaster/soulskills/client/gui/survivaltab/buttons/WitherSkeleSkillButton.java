 ...
 */
public class WitherSkeleSkillButton extends GuiButton {
    private ResourceLocation texture;

    public WitherSkeleSkillButton(int id, int x, int y, String text, ResourceLocation texture) {
    ...
    public void drawButton(Minecraft mc, int par2, int par3, float partialTicks) {
        if(enabled) {
            ...
            drawTexturedModalRect(x, y, 20, k == 2 ? 100 : 80, 20, 20);
        }
    }
}
