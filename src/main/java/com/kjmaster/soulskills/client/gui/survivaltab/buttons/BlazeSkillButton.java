 ...
 */
public class BlazeSkillButton extends GuiButton {
    private ResourceLocation texture;

    public BlazeSkillButton(int id, int x, int y, String text, ResourceLocation texture) {
    ...
    public void drawButton(Minecraft mc, int par2, int par3, float partialTicks) {
        if(enabled) {
            ...
            drawTexturedModalRect(x, y, 80, k == 2 ? 20 : 0, 20, 20);
        }
    }
}
