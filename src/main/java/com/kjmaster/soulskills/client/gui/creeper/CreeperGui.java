package com.kjmaster.soulskills.client.gui.creeper;
 ...
 */
public class CreeperGui extends MobGui {


    public CreeperGui(Container inventorySlotsIn) {
    ...
    public void updateScreen() {
        ...
        super.updateScreen();
        SoulSkillsPacketInstance.INSTANCE.sendToServer(new GetSoulsPacket("Creeper"));
        ...
        String s = "Creeper Souls: " + soulsCreeper;
