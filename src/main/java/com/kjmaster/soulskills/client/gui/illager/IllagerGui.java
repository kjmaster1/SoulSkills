package com.kjmaster.soulskills.client.gui.illager;
 ...
 */
public class IllagerGui extends MobGui {

    public IllagerGui(Container inventorySlotsIn) {
    ...
    public void updateScreen() {
        super.updateScreen();
        SoulSkillsPacketInstance.INSTANCE.sendToServer(new GetSoulsPacket("Illager"));
        EntityPlayer player = Minecraft.getMinecraft().player;
        ISouls soulsCap = player.getCapability(SoulsProvider.SOULS_CAPABILITY, null);
        int soulsIllager = soulsCap.getSouls("Illager");
        String s = "Illager Souls: " + soulsIllager;
