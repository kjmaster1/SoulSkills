package com.kjmaster.soulskills.client.gui.guardian;
 ...
 */
public class GuardianGui extends MobGui {

    public GuardianGui(Container inventorySlotsIn) {
    ...
    public void updateScreen() {
        super.updateScreen();
        SoulSkillsPacketInstance.INSTANCE.sendToServer(new GetSoulsPacket("Guardian"));
        EntityPlayer player = Minecraft.getMinecraft().player;
        ISouls soulsCap = player.getCapability(SoulsProvider.SOULS_CAPABILITY, null);
        int soulsGuardian = soulsCap.getSouls("Guardian");
        String s = "Guardian Souls: " + soulsGuardian;
