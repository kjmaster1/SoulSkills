package com.kjmaster.soulskills.client.gui.pigmen;
 ...
 */
public class PigmenGui extends MobGui {

    public PigmenGui(Container inventorySlotsIn) {
    ...
    public void updateScreen() {
        ...
        super.updateScreen();
        SoulSkillsPacketInstance.INSTANCE.sendToServer(new GetSoulsPacket("Pigmen"));
        EntityPlayer player = Minecraft.getMinecraft().player;
        ISouls soulsCap = player.getCapability(SoulsProvider.SOULS_CAPABILITY, null);
        int soulsPigmen = soulsCap.getSouls("Pigmen");
        String s = "Pigmen Souls: " + soulsPigmen;
