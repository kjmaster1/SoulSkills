package com.kjmaster.soulskills.client.gui.silverfish;
 ...
 */
public class SilverfishGui extends MobGui {

    public SilverfishGui(Container inventorySlotsIn) {
    ...
    public void updateScreen() {
        super.updateScreen();
        SoulSkillsPacketInstance.INSTANCE.sendToServer(new GetSoulsPacket("Silverfish"));
        EntityPlayer player = Minecraft.getMinecraft().player;
        ISouls soulsCap = player.getCapability(SoulsProvider.SOULS_CAPABILITY, null);
        int soulsSilverfish = soulsCap.getSouls("Silverfish");
        String s = "Silverfish Souls: " + soulsSilverfish;
