package com.kjmaster.soulskills.client.gui.ghast;
 ...
 */
public class GhastGui extends MobGui {

    public GhastGui(Container inventorySlotsIn) {
    ...
    public void updateScreen() {
        ...
        super.updateScreen();
        SoulSkillsPacketInstance.INSTANCE.sendToServer(new GetSoulsPacket("Ghast"));
        EntityPlayer player = Minecraft.getMinecraft().player;
        ISouls soulsCap = player.getCapability(SoulsProvider.SOULS_CAPABILITY, null);
        int soulsGhast = soulsCap.getSouls("Ghast");
        String s = "Ghast Souls: " + soulsGhast;
