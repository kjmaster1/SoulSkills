package com.kjmaster.soulskills.client.gui.shulker;
 ...
 */
public class ShulkerGui extends MobGui {

    public ShulkerGui(Container inventorySlotsIn) {
    ...
    public void updateScreen() {
        super.updateScreen();
        SoulSkillsPacketInstance.INSTANCE.sendToServer(new GetSoulsPacket("Shulker"));
        EntityPlayer player = Minecraft.getMinecraft().player;
        ISouls soulsCap = player.getCapability(SoulsProvider.SOULS_CAPABILITY, null);
        int soulsShulker = soulsCap.getSouls("Shulker");
        String s = "Shulker Souls: " + soulsShulker;
